...
class ControllerUserUserPermission extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('user/user_permission', 't=' . $this->session->data['t'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('user/user_permission', 't=' . $this->session->data['t'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
							
		$this->data['insert'] = $this->url->link('user/user_permission/insert', 't=' . $this->session->data['t'] . $url, 'SSL');
		$this->data['delete'] = $this->url->link('user/user_permission/delete', 't=' . $this->session->data['t'] . $url, 'SSL');	
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('user/user_permission/update', 't=' . $this->session->data['t'] . '&user_group_id=' . $result['user_group_id'] . $url, 'SSL')
			);		
		...
		$this->data['sort_name'] = $this->url->link('user/user_permission', 't=' . $this->session->data['t'] . '&sort=name' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('user/user_permission', 't=' . $this->session->data['t'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['user_group_id'])) {
			$this->data['action'] = $this->url->link('user/user_permission/insert', 't=' . $this->session->data['t'] . $url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('user/user_permission/update', 't=' . $this->session->data['t'] . '&user_group_id=' . $this->request->get['user_group_id'] . $url, 'SSL');
		}
		  
    	$this->data['cancel'] = $this->url->link('user/user_permission', 't=' . $this->session->data['t'] . $url, 'SSL');
