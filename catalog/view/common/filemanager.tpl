...
$(document).ready(function() { 
	...
	$('#column-right').bind('scrollstop', function() {
		$('#column-right a').each(function(index, element) {
			...
			if ((offset.top > 0) && (offset.top < height) && $(element).find('img').attr('src') == '<?php echo $no_image; ?>') {
				$.ajax({
					url: 'index.php?route=common/filemanager/image&t=<?php echo $t; ?>&image=' + encodeURIComponent('data/' + $(element).find('input[name=\'image\']').attr('value')),
					dataType: 'html',
	...
	$('#column-left').tree({
		data: { 
			...
			opts: { 
				method: 'post', 
				url: 'index.php?route=common/filemanager/directory&t=<?php echo $t; ?>'
			} 
		},
		selected: 'top',
		ui: {		
		...
		callback: {
			...
			onselect: function (NODE, TREE_OBJ) {
				$.ajax({
					url: 'index.php?route=common/filemanager/files&t=<?php echo $t; ?>',
					type: 'post',
	...
	$('#create').bind('click', function() {
		...
		if (tree.selected) {
			...
			$('#dialog input[type=\'button\']').bind('click', function() {
				$.ajax({
					url: 'index.php?route=common/filemanager/create&t=<?php echo $t; ?>',
					type: 'post',
	...
	$('#delete').bind('click', function() {
		...
		if (path) {
			$.ajax({
				url: 'index.php?route=common/filemanager/delete&t=<?php echo $t; ?>',
				type: 'post',
	...
	$('#move').bind('click', function() {
		...
		$('#dialog select[name=\'to\']').load('index.php?route=common/filemanager/folders&t=<?php echo $t; ?>');
		...
		$('#dialog input[type=\'button\']').bind('click', function() {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?route=common/filemanager/move&t=<?php echo $t; ?>',
					type: 'post',
	...
	$('#copy').bind('click', function() {
		...
		$('#dialog input[type=\'button\']').bind('click', function() {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?route=common/filemanager/copy&t=<?php echo $t; ?>',
					type: 'post',
	...
	$('#rename').bind('click', function() {
		...
		$('#dialog input[type=\'button\']').bind('click', function() {
			...
			if (path) {		
				$.ajax({
					url: 'index.php?route=common/filemanager/rename&t=<?php echo $t; ?>',
					type: 'post',
					data: 'path=' + encodeURIComponent(path) + '&name=' + encodeURIComponent($('#dialog input[name=\'name\']').val()),
					dataType: 'json',
					success: function(json) {
	...
	new AjaxUpload('#upload', {
		action: 'index.php?route=common/filemanager/upload&t=<?php echo $t; ?>',
		name: 'image',
		autoSubmit: false,
		responseType: 'json',
		...
		onSubmit: function(file, extension) {
			$('#upload').append('<img src="static/image/loading.gif" class="loading" style="padding-left: 5px;" />');
		},
