...
<div class="contents">
  <div class="box">
    <div class="heading">
      <h1><img src="static/image/home.png" alt="" /> <?php echo $heading_title; ?></h1>
    </div>
    <div class="contents">
      <div class="overview">
      ...
      <div class="latest">
        <div class="dashboard-heading"><?php echo $text_latest_100_orders; ?></div>
...
function getSalesChart(range) {
	$.ajax({
		type: 'get',
		url: 'index.php?route=common/home/chart&t=<?php echo $t; ?>&range=' + range,
		dataType: 'json',
		async: false,
