...
class ControllerUserGroup extends Controller {  
	...
	public function __construct($registry){
		...
		$this->data['user_action'] =$this->url->link('user/user/getList', 'token=' . $this->session->data['token'], 'SSL');
        $this->data['group_action'] =$this->url->link('user/group', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['group']='active';
	}
  	...
  	public function index() {
		...
		if (isset($this->request->get['page'])) {
  		...
  		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('user/group', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);
							
		$this->data['insert'] = $this->url->link('user/group/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['delete'] = $this->url->link('user/group/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');	
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('user/group/update', 'token=' . $this->session->data['token'] . '&user_group_id=' . $result['user_group_id'] . $url, 'SSL')
			);		
		...
		$this->data['sort_name'] = $this->url->link('user/group', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('user/group', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('user/group', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['user_group_id'])) {
			$this->data['action'] = $this->url->link('user/group/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('user/group/update', 'token=' . $this->session->data['token'] . '&user_group_id=' . $this->request->get['user_group_id'] . $url, 'SSL');
		}
		  
    	$this->data['cancel'] = $this->url->link('user/group', 'token=' . $this->session->data['token'] . $url, 'SSL');
