<?php
 class ControllerAccountGroup extends Controller {
    ...
    public function getList(){
        ...
        $groups= $this->model_client_group->getGroups($this->request->get);

        $total=$this->model_client_group->getGroupsTotal($this->request->get);
        ...
        $pagination->url = $this->url->link('client/group', 'token=' . $this->session->data['token']  . '&page={page}', 'SSL');
