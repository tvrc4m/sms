...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("select[name='platform_id']").change(function(){
            ...
            var url = 'index.php?route=sale/order/getPlatformChannelsByPlatformID&token=<?php echo $token; ?>';
        ...
        $("select[name='lodge_building_id']").change(function(){
            ...
            var url = 'index.php?route=sale/order/getRoomTypesByBuildingID&token=<?php echo $token; ?>';
        ...
        $("select[name='room_type_id']").change(function(){
            ...
            var url = 'index.php?route=sale/order/getRoomsByRoomTypeID&token=<?php echo $token; ?>';
